...
namespace CoreDataStore
{
    public static class ThreadDeathWatcher
    {
        ...
        static readonly ConcurrentQueue<Entry> PendingEntries = new ConcurrentQueue<Entry>();
        static readonly Watcher watcher = new Watcher();
        static int started;
        static volatile POPThread watcherThread;
        ...
        sealed class Entry
        {
            internal readonly POPThread Thread;
            ...
            public override int GetHashCode() { return this.Thread.GetHashCode() ^ this.Task.GetHashCode(); }
